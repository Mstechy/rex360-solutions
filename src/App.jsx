...
function AppContent() {
  ...
  useEffect(() => {
    trackSiteEvent('page_view', location.pathname);
  }, [location.pathname]);
  ...
  useEffect(() => {
    const trackClick = (event) => {
      ...
      const label = target.getAttribute('aria-label') || target.textContent?.trim() || target.href || 'Unlabelled action';
      trackSiteEvent('click', label);
    };
