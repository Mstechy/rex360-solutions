...
import { Calendar, User, Loader, ArrowRight, Tag } from 'lucide-react';
import { supabase } from '../SupabaseClient'; // Connected to your Database
...
const NewsPage = () => {
  ...
  // FETCH ALL NEWS (No Limit)
  useEffect(() => {
    const fetchAllNews = async () => {
      // Get everything, newest first
